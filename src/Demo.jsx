    ...
    <section className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 pt-24 pb-16 px-4 sm:px-6 md:px-12">
      ...
      {user?.role === "admin" && (
        <button
          ...
          className="fixed bottom-8 right-8 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-full shadow-lg p-4 transition transform hover:scale-110 hover:shadow-purple-400"
